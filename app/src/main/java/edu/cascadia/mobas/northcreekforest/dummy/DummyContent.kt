package edu.cascadia.mobas.northcreekforest.dummy
...
object DummyContent {
    ...
    class DummyItem(val id: String, val content: String, val details: String, val info: String) {
